...
Use the dim() function to find the dimensions of the colData, rowRanges@elementMetadata, and unstranded dataframes. Record them below:
  ...
  ~ colData (rows, cols): 473 patients, 175 clinical features
  ~ rowRanges@elementMetadata: 60660, 10
  ~ unstranded: 60660 rows, 473 cols
...
```{r Exercise 5.10}
# write code here
normal_mask = ifelse(rna_clinical$definition == 'Solid Tussue Normal', F, T)
...
rna_counts = rna)counts[, normal_mask]
```
...
vital_make = rna_clinical$vital_status != 'Not Reported'
