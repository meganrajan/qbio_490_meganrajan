...
name = "Megan" # string
age = 20 # integer
birthday = "08/05/2003" # string
three_fav_colors = c("red", "blue", "yellow") # vector of strings
...
```{r Exercise 9.4}
# write code here
am_column_index <- which(colnames(mtcars) == "am")

# Create a copy of mtcars without the "am" column
mtcars_copy <- mtcars[, -am_column_index]
```
